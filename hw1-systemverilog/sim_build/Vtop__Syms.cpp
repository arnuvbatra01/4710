    ...
    , TOP{this, namep}
{
    ...
    __Vscope_rca4__a3.configure(this, name(), "rca4.a3", "a3", "fulladder2", -9, VerilatedScope::SCOPE_MODULE);
    __Vscope_rca4__a3__a0.configure(this, name(), "rca4.a3.a0", "a0", "fulladder1", -9, VerilatedScope::SCOPE_MODULE);
    __Vscope_rca4__a3__a0__h0.configure(this, name(), "rca4.a3.a0.h0", "h0", "halfadder", -9, VerilatedScope::SCOPE_MODULE);
    __Vscope_rca4__a3__a0__h1.configure(this, name(), "rca4.a3.a0.h1", "h1", "halfadder", -9, VerilatedScope::SCOPE_MODULE);
    __Vscope_rca4__a3__a1.configure(this, name(), "rca4.a3.a1", "a1", "fulladder1", -9, VerilatedScope::SCOPE_MODULE);
    __Vscope_rca4__a3__a1__h0.configure(this, name(), "rca4.a3.a1.h0", "h0", "halfadder", -9, VerilatedScope::SCOPE_MODULE);
    __Vscope_rca4__a3__a1__h1.configure(this, name(), "rca4.a3.a1.h1", "h1", "halfadder", -9, VerilatedScope::SCOPE_MODULE);
